...
| 폴더 | 내용 |
|---|---|
| [AES-256-GCM Core 설계](https://github.com/Bourrasque-21/aes256-gcm-occ/tree/main/AES256_GCM_Core) | 플랫폼·AXI 계층과 분리된 AES-256-GCM TX/RX 연산 엔진, 코어 테스트벤치, NIST AES-256 KAT 검증 |
| [Rolling-Shutter OCC v3 설계](https://github.com/Bourrasque-21/aes256-gcm-occ/tree/main/Rolling_Shutter_OCC) | Basys3 두 대와 OV7670을 사용하는 Rolling-Shutter OCC v3 송수신 RTL 및 수신 도구 |
